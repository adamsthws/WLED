...
// Gap left above to allow space for new usermods to be added without clashing the below usermod
#define USERMOD_ID_CONDITIONAL_TRIGGER   99     //Usermod "conditional_triggering.h"
